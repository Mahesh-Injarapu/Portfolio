...
export default function Overlay({ scrollYProgress }: { scrollYProgress: MotionValue<number> }) {
    return (
        <>
            <Section
                text="Mahesh Injarapu."
                subText="Full Stack Developer & AI Engineer"
                align="center"
                start={0.05}
                end={0.2}
            ...
            />
            <Section
                text="Dr.RVR NRI Institute of Technology Deemed to be University."
                subText="B.Tech Student in Computer Science Engineering (AIML)"
                align="left"
                start={0.3}
                end={0.45}
                scrollYProgress={scrollYProgress}
            ...
            <Section
                ...
                subText="Developing Jarvis AI, AI Air Mouse, and Placement360 AI."
                align="right"
                start={0.6}
                end={0.75}
                scrollYProgress={scrollYProgress}
